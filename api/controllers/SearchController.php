<?php
// Search Controller - Global Search (Omni-Search)
authCheck();
...
// 2. Search Menus
// We'll search through the menus table
$menus = $db->fetchAll(
...
// 3. Search Transactions (Optional: Pinjaman/Simpanan by No Transaksi)
...
foreach ($pinjaman as $p) {
    $results[] = [
        ...
        'url' => "#/pinjaman", // Could be more specific if detail page exists
